...
public class BackStagePassQualityStrategy extends AbstractItemQualityStrategy {
	/**
	 * The quality delta is +1 when the sellIn date is 10 days away or more. The
	 * quality delta is +2 when the sellIn date is 5 to 10 days away. The quality
	 * delta is +3 when the sellIn date is 0 to 5 days away. The quality drops to 0
	 * when the sellIn date is reached.
	 * 
